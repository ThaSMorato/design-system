...
/** Status dot size class by avatar size. */
export function avatarStatusSize(size: AvatarSize | null | undefined): string {
  switch (size) {
...
export const AVATAR_STATUS_BASE = 'absolute bottom-0 right-0 block rounded-full ring-2 ring-dark-800';
