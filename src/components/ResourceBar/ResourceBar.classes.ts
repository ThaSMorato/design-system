...
export const RESOURCE_TRACK_INNER_CLASS = 'relative h-full w-full';
export const RESOURCE_FILL_CLASS = 'h-full transition-all duration-300';
export const RESOURCE_TEMP_FILL_CLASS = 'absolute top-0 h-full bg-blue-400/60 transition-all duration-300';
